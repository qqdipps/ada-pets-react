    ...
    <div className="card pet-card">
      <section className="pet-card--header">
        ...
        <button
          ...
          onClick={() => props.onSelectPetCallback(id)}
        >
          Select
        </button>
        <button
          ...
          aria-label="Close"
          onClick={() => props.onPetRemoveCallback(id)}
        >
          Remove
        </button>
      </section>
      ...
      <section className="pet-card--footer text-muted">{location}</section>
    </div>
  );
};
...
PetCard.propTypes = {
  ...
  onPetRemoveCallback: PropTypes.func,
};
